...
async function init(){
    ...
    await fetch("https://raw.githubusercontent.com/RichFlight22/GEOFS-LiverySelector-TEST/main/livery.json").then(res => res.json()).then(data => liveryobj = data)
